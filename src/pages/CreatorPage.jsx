...
const CreatorPage = () => {
  ...
  return (
    <div className="p-4">
      ...
      <Link to="/creator/new" className="bg-gray-700 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded mb-4 inline-block">
        Create New Adventure
      </Link>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
        {adventures?.map((adventure) => (
          <Link to={`/creator/${adventure.id}`} key={adventure.id} className="bg-surface p-4 rounded-lg shadow-md cursor-pointer hover:bg-gray-700 transition-colors duration-200">
